...
function caricaMusica(track_index,controllo) {
    fetch(`https://striveschool-api.herokuapp.com/api/deezer/album/${session}`).then(function (response) {
        ...
        function playTrack() {
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="rgb(96, 190, 96)" class="bi bi-pause-circle-fill text-success me-lg-4 manina" viewBox="0 0 16 16">
        ...
        function pauseTrack() {
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="rgb(96, 190, 96)"
