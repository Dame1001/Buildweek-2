        ...
        for (let i = 0; i < album.tracks.data.length; i++) {
            div.innerHTML +=
                `<tr>
                    ...
                    <td><p class="m-0 fw-bold manina" onclick="caricaMusica(${i})">${album.tracks.data[i].title}</p><p class="m-0 fw-light manina" onclick="getIdArtist(${album.artist.id})">${album.tracks.data[i].artist.name}</p></td>
